...
const cards = (
  ...
  >
    ...
    <g id="ab">
      <path
        d="M48.35,7.19V56.81h6.69c2.19,0,3.95-1.76,3.95-3.96V11.14c0-2.19-1.76-3.96-3.95-3.96h-6.69Z"
        fill="#8fd7f8"
        fill-rule="evenodd"
      />

      <path
        d="M41.66,7.19V56.81h6.69c2.19,0,3.96-1.76,3.96-3.96V11.14c0-2.19-1.77-3.96-3.96-3.96h-6.69Z"
        fill="#f0f3f5"
        fill-rule="evenodd"
      />

      <path
        d="M34.97,7.19V56.81h6.69c2.19,0,3.95-1.76,3.95-3.96V11.14c0-2.19-1.76-3.96-3.95-3.96h-6.69Z"
        fill="#8fd7f8"
        fill-rule="evenodd"
      />

      <path
        d="M8.95,7.19h26.01c2.18,0,3.95,1.77,3.95,3.95V52.86c0,2.18-1.77,3.96-3.96,3.96H8.95c-2.18,0-3.95-1.77-3.95-3.95V11.14c0-2.18,1.77-3.95,3.95-3.95Z"
        fill="#f0f3f5"
      />

      <path
        d="M33.93,32c0,6.61-5.36,11.97-11.97,11.97s-11.97-5.36-11.97-11.97,5.36-11.97,11.97-11.97,11.97,5.36,11.97,11.97Z"
        fill="#8996a8"
        fill-rule="evenodd"
      />

      <path
        d="M21.96,25.82c-.29,0-.57,.11-.79,.33l-3.33,3.33c-1.14,1.14-1.14,2.98,0,4.12,.67,.67,1.57,.94,2.43,.83l-.35,1.71c-.23,1.11,.91,2.04,2.04,2.04s2.26-.93,2.04-2.04l-.35-1.71c.86,.11,1.77-.16,2.43-.83,1.14-1.14,1.14-2.98,0-4.12l-3.33-3.33c-.22-.22-.51-.33-.79-.33Z"
        fill="#e8a3c1"
        fill-rule="evenodd"
      />

      <path
        d="M21.96,20.03c-.6,0-1.2,.05-1.8,.14,5.83,.9,10.14,5.92,10.14,11.83,0,5.91-4.32,10.93-10.15,11.82,.6,.1,1.21,.14,1.82,.15,6.61,0,11.97-5.36,11.97-11.97,0-6.61-5.36-11.97-11.97-11.97Z"
        fill="#7a8594"
        fill-rule="evenodd"
      />

      <path
        d="M50.97,7.19c2.19,0,3.95,1.76,3.95,3.96V52.86c0,2.19-1.76,3.96-3.95,3.96h4.07c2.19,0,3.95-1.76,3.95-3.96V11.14c0-2.19-1.76-3.96-3.95-3.96h-4.07Z"
        fill="#75cdf8"
        fill-rule="evenodd"
      />

      <path
        d="M44.28,7.19c2.19,0,3.95,1.76,3.95,3.96V52.86c0,2.19-1.76,3.96-3.95,3.96h4.07c2.19,0,3.96-1.76,3.96-3.96V11.14c0-2.19-1.76-3.96-3.96-3.96h-4.07Z"
        fill="#e4ecf0"
        fill-rule="evenodd"
      />

      <path
        d="M37.58,7.19c2.19,0,3.95,1.76,3.95,3.96V52.86c0,2.19-1.76,3.96-3.95,3.96h4.07c2.19,0,3.96-1.76,3.96-3.96V11.14c0-2.19-1.76-3.96-3.96-3.96h-4.07Z"
        fill="#75cdf8"
        fill-rule="evenodd"
      />

      <path
        d="M30.89,7.19c2.19,0,3.95,1.76,3.95,3.96V52.86c0,2.19-1.76,3.96-3.95,3.96h4.07c2.19,0,3.95-1.76,3.95-3.96V11.14c0-2.19-1.76-3.96-3.95-3.96h-4.07Z"
        fill="#e4ecf0"
        fill-rule="evenodd"
      />
      ...
      <div className="menu__box">
        {MENUITEMS.map((item) => (
          <div
            ...
            style={{ width: item === isActive ? "35%" : "" }}
            className="menu__item"
          >
            <span className="menu__icon">{cards}</span>
          </div>
        ))}
      </div>
    </div>
